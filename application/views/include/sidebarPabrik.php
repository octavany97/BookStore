      ...
      <div class="sidebar left ">
        <div class="user-panel">
          ...
          <div class="pull-left info">
            <!-- nanti ubah sama nama/username yang login -->
            <p>Admin Pabrik</p>
            <a href="#"><i class="fa fa-circle text-success"></i> Online</a>
          </div>
        </div>
        <ul class="list-sidebar bg-defoult">
        <li> <a href="#"> <i class="fa fa-th-large"></i> <span class="nav-label"> Dashboards </span> </a></li>
        <li> <a href="#"><i class="fa fa-diamond"></i> <span class="nav-label">Layouts</span></a> </li>
        <li> <a href="#" data-toggle="collapse" data-target="#products" class="collapsed active" > <i class="fa fa-shopping-cart"></i> <span class="nav-label">Product List</span> <span class="fa fa-chevron-left pull-right"></span> </a>
